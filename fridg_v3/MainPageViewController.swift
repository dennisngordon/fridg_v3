...
//  fridg_v3
//
//  Created by Dennis Gordon on 2016-09-26.
...
class MainPageViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
       ...
       if(profilePhotoImageView.image == nil)
       {
          ...
          let imageUrl = URL(string:"http://localhost/fridgapp/profile-pictures/\(userId!)/user-profile.jpg")
    ...
    {
       let myUrl = URL(string: "http://localhost/fridgapp/scripts/imageUpload.php");
